...
/*==================== SERVICES MODAL ====================*/
const modelView = document.querySelectorAll('.services_model');
const modelBtns = document.querySelectorAll('.services_button')
const modelClose = document.querySelectorAll('.services_model-close')

let model = function(modelClick) {
    modelView[modelClick].classsList.add('active-model');
}
...
const iconTheme = '<i class="uil uil-sun'
